const families = ['Fade','Rise','Drop','SlideLeft','SlideRight','Scale','Blur','Focus','Reveal','Clip','Mask','Push','Pull','Drift','Float','Parallax','Depth','Rotate','Skew','Split','Curtain','Glide','Track','Zoom','Pulse']
...
export const MOTION_PRESETS = Object.freeze(Object.fromEntries(
  families.flatMap((family, familyIndex) => variants.map((variant, variantIndex) => {
    ...
    return [
      ...
      Object.freeze({
        ...
        seed: familyIndex * 31 + variantIndex * 7,
      }),
    ]
  })),
))
