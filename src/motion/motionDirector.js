...
const variantMap = {
  soft: { distance: 0.65, blur: 0.12, scale: 0.985, duration: 1.35, rotation: 0.65 },
  strong: { distance: 1.35, blur: 0.24, scale: 0.965, duration: 0.95, rotation: 1.0 },
  slow: { distance: 1.05, blur: 0.14, scale: 0.98, duration: 1.65, rotation: 0.7 },
  fast: { distance: 0.85, blur: 0.12, scale: 0.975, duration: 0.65, rotation: 1.0 },
  elastic: { distance: 1.2, blur: 0.16, scale: 0.97, duration: 1.1, rotation: 1.15 },
  smooth: { distance: 0.95, blur: 0.12, scale: 0.98, duration: 1.25, rotation: 0.7 },
  sharp: { distance: 0.8, blur: 0.08, scale: 0.978, duration: 0.8, rotation: 0.9 },
  cinematic: { distance: 1.1, blur: 0.18, scale: 0.97, duration: 1.45, rotation: 0.8 },
  fluid: { distance: 0.9, blur: 0.1, scale: 0.982, duration: 1.15, rotation: 0.95 },
  deep: { distance: 1.5, blur: 0.28, scale: 0.95, duration: 1.55, rotation: 0.9 },
  wide: { distance: 1.25, blur: 0.14, scale: 0.97, duration: 1.2, rotation: 0.8 },
  micro: { distance: 0.35, blur: 0.04, scale: 0.992, duration: 0.55, rotation: 0.5 },
}
...
const familyMap = {
  ...
  whip:{x:1.2,y:0.15,z:0.15,rotate:1.4}, sweep:{x:1,y:0.25,z:0.25,rotate:0.6}, wipe:{x:0.7,y:0.05,z:0,rotate:0}, shutter:{x:0,y:1.1,z:0,rotate:0},
  fold:{x:0.55,y:0.55,z:-0.8,rotate:1.1}, unfold:{x:-0.55,y:-0.55,z:0.6,rotate:-1.1}, flip:{x:0,y:0,z:-0.9,rotate:2.2}, orbit:{x:0.7,y:0.4,z:0.25,rotate:2.4},
  arc:{x:0.75,y:0.55,z:0.1,rotate:1.8}, wave:{x:0.7,y:0.45,z:0,rotate:1.2}, ripple:{x:0.25,y:0.7,z:-0.2,rotate:0.7}, elastic:{x:0,y:0.9,z:-0.15,rotate:-0.8},
  bounce:{x:0,y:1.2,z:0,rotate:0.4}, spring:{x:0,y:1,z:0.15,rotate:-0.7}, snap:{x:0.2,y:0.4,z:0,rotate:1.2}, magnetic:{x:0.55,y:0.35,z:0.25,rotate:0.5},
  floatup:{x:0.1,y:0.8,z:0.1,rotate:0.2}, floatdown:{x:-0.1,y:-0.8,z:0.1,rotate:-0.2}, driftleft:{x:0.85,y:0.15,z:0,rotate:-0.2}, driftright:{x:-0.85,y:0.15,z:0,rotate:0.2},
  driftup:{x:0.15,y:0.75,z:0,rotate:0.2}, driftdown:{x:0.15,y:-0.75,z:0,rotate:-0.2}, pan:{x:1,y:0,z:0.2,rotate:0}, tilt:{x:0,y:0.2,z:0,rotate:1.2}, roll:{x:0,y:0,z:0,rotate:2.5},
  lens:{x:0,y:0,z:0.8,rotate:0}, rackfocus:{x:0,y:0,z:0.6,rotate:0}, dolly:{x:0,y:0,z:-1,rotate:0}, truck:{x:0.9,y:0,z:0,rotate:0}, pedestal:{x:0,y:-0.85,z:0,rotate:0},
  crane:{x:0.2,y:-0.95,z:0.3,rotate:0.2}, boom:{x:0,y:-1.1,z:-0.2,rotate:0}, jitter:{x:0.25,y:0.25,z:0,rotate:1.2}, vibrate:{x:0.08,y:0.18,z:0,rotate:0.5}, breath:{x:0,y:0,z:0.4,rotate:0},
  glow:{x:0,y:0,z:0.25,rotate:0}, trace:{x:0.2,y:0.55,z:0,rotate:0}, draw:{x:0.45,y:0.35,z:0,rotate:0.2}, erase:{x:-0.45,y:-0.2,z:0,rotate:-0.2}, stretch:{x:0.9,y:0,z:0,rotate:0}, compress:{x:-0.7,y:0,z:0,rotate:0},
  expand:{x:0,y:0,z:0,rotate:0}, contract:{x:0,y:0,z:0,rotate:0}, cascade:{x:0.3,y:0.8,z:0,rotate:0.4}, domino:{x:0.75,y:0.6,z:-0.1,rotate:0.9}, stack:{x:0,y:0.65,z:-0.3,rotate:0.3}, fan:{x:0.8,y:0.4,z:0,rotate:1.4},
  scatter:{x:1,y:0.8,z:-0.4,rotate:1.8}, assemble:{x:-1,y:-0.7,z:0.5,rotate:-1.4}, splittext:{x:0.6,y:0,z:0,rotate:0.15},
}
...
const fallbackPresets = [
  ...
  'WhipFast','SweepFluid','OrbitCinematic','WaveSmooth','SpringElastic',
  'MagneticMicro','RackFocusCinematic','DollySlow','CascadeCinematic','SplitTextFluid',
]
